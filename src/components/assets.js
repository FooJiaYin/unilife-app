...
export default function Asset(name) {
    ...
    if (name == 'topic-16') return require('../../assets/topics/cover_16.jpg')
    if (name == 'topic-17') return require('../../assets/topics/cover_17.jpg')
    if (name == 'topic-18') return require('../../assets/topics/cover_18.jpg')
    if (name == 'topic-19') return require('../../assets/topics/cover_19.jpg')
    if (name == 'topic-20') return require('../../assets/topics/cover_20.jpg')
    if (name == 'topic-21') return require('../../assets/topics/cover_21.jpg')
    if (name == 'topic-22') return require('../../assets/topics/cover_22.jpg')
    if (name == 'topic-23') return require('../../assets/topics/cover_23.jpg')
    if (name == 'topic-24') return require('../../assets/topics/cover_24.jpg')
    if (name == 'topic-25') return require('../../assets/topics/cover_25.jpg')
    if (name == 'topic-26') return require('../../assets/topics/cover_26.jpg')
    if (name == 'topic-27') return require('../../assets/topics/cover_27.jpg')
    if (name == 'topic-28') return require('../../assets/topics/cover_28.jpg')
    if (name == 'topic-29') return require('../../assets/topics/cover_29.jpg')
